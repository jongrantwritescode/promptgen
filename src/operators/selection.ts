import { Prompt, Config, SelectionOperator } from "../types.js";

export const tournamentSelection: SelectionOperator = {
  name: "tournament",
...
export const rouletteSelection: SelectionOperator = {
  name: "roulette",
  select: (population: Prompt[], count: number, config: Config): Prompt[] => {
    const selected: Prompt[] = [];
